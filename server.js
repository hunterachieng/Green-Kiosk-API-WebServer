...
server.listen(5003); // listen for any incoming requests

console.log('Node.js web server at port 5003 is running..')

// http.get("http://127.0.0.1:5003/products/vegetables",(req,res)=>{
//   res.JSON(server)
// })
